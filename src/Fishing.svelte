...
<div class="icon">
  <svg id="fishing" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" height={height} width={width}>
    <g transform="matrix(1.2 0 0 1.2 -8 -16)" stroke-width="4.167" fill="none" stroke={stroke}>
